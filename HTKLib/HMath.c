...
static void CopyNSegmentCPU(NFloat *srcPtr, int segLen, NFloat *dstPtr) {
   memcpy(dstPtr, srcPtr, segLen * sizeof(NFloat));
}

#ifdef MKL
static void CopyNSegmentMKL(NFloat *srcPtr, int segLen, NFloat *dstPtr) {
    #ifdef DOUBLEANN
...
static void AddNSegmentCPU(NFloat *srcPtr, int segLen, NFloat *dstPtr) {
    int i;
...
#ifdef MKL
static void AddNSegmentMKL(NFloat *srcPtr, int segLen, NFloat *dstPtr) {
    #ifdef DOUBLEANN
...
#ifdef MKL
static void ScaleNSegmentMKL(int segLen, NFloat scale, NFloat *valPtr) {
    #ifdef DOUBLEANN
...
static void ScaleNSegmentCPU(int segLen, NFloat scale, NFloat *valPtr) {
    int i;
...
#ifdef MKL
static void ScaledSelfAddNSegmentMKL(NFloat *rhPtr, int segLen, NFloat scale, NFloat *lhPtr) {
    #ifdef DOUBLEANN
...
static void ScaledSelfAddNSegmentCPU(NFloat *rhPtr, int segLen, NFloat scale, NFloat *lhPtr) {
    int i;
...
static void DupNSegmentCPU(NFloat *srcPtr, int segLen, NFloat *dstPtr, int times) {
    int i, off;
...
#ifdef MKL
static void DupNSegmentMKL(NFloat *srcPtr, int segLen, NFloat *dstPtr, int times) {
    int i, off;
...
static void SubNSegmentCPU(NFloat *lhPtr, NFloat *rhPtr, int segLen, NFloat *resPtr) {
    int i;
...
#ifdef MKL
static void SubNSegmentMKL(NFloat *lhPtr, NFloat *rhPtr, int segLen, NFloat *resPtr) {
    #ifdef DOUBLEANN
...
static void MulNSegmentCPU(NFloat *lhPtr, NFloat *rhPtr, int segLen, NFloat *resPtr) {
    int i;
...
#ifdef MKL
static void MulNSegmentMKL(NFloat *lhPtr, NFloat *rhPtr, int segLen, NFloat *resPtr) {
    #ifdef DOUBLEANN
...
/* cz277 - laf */
static void ApplyAffineActCPU(NFloat *srcPtr, int row, int col, NFloat *scalePtr, NFloat *shiftPtr, NFloat *dstPtr) {
    int i, j;
...
/* cz277 - laf */
#ifdef MKL
static void ApplyAffineActMKL(NFloat *srcPtr, int row, int col, NFloat *scalePtr, NFloat *shiftPtr, NFloat *dstPtr) {
    int i;
...
/* cz277 - pact */
static void ApplyDAffineActCPU(NFloat *srcPtr, int row, int col, NFloat *scalePtr, NFloat *shiftPtr, NFloat *dstPtr) {
    int i;
...
/* cz277 - pact */
static void ApplyTrAffineActCPU(NFloat *errPtr, NFloat *actPtr, int row, int col, NFloat *scalePtr, NFloat *shiftPtr, Boolean accFlag, NFloat *dScalePtr, NFloat *dShiftPtr) {
    int i, j;
...
/* cz277 - laf */
static void AccMeanNSegmentCPU(NFloat *valPtr, int row, int col, NFloat tSamp, NFloat *meanPtr) {
    int i, j;
...
/* cz277 - laf */
static void AccVarianceNSegmentCPU(NFloat *valPtr, int row, int col, NFloat tSamp, NFloat *meanPtr, NFloat *varPtr) {
    int i, j;
...
static void ApplyReLUActCPU(NFloat *srcPtr, int len, NFloat scale, NFloat *dstPtr) {
    int i;
...
static void ApplyDReLUActCPU(NFloat *srcPtr, int len, NFloat scale, NFloat *dstPtr) {
    int i;
...
static void ApplyDLinearActCPU(NFloat *srcPtr, int len, NFloat *dstPtr) {
    int i;
...
/* cz277 - pact */
static void ApplyPSigmoidActCPU(NFloat *srcPtr, int row, int col, NFloat *etaPtr, NFloat *dstPtr) {
    int i, j, pos;
    NFloat floatVal;
...
/* cz277 - pact */
static void ApplyDPSigmoidActCPU(NFloat *srcPtr, int row, int col, NFloat *etaPtr, NFloat *dstPtr) {
    int i, j, pos;
...
/* cz277 - pact */
static void ApplyTrPSigmoidActCPU(NFloat *errPtr, NFloat *srcPtr, NFloat *etaPtr, int row, int col, Boolean accFlag, NFloat *dEtaPtr) {
    int i, j, pos;
...
/* cz277 - pact */
static void ApplyParmSigmoidActCPU(NFloat *srcPtr, int row, int col, NFloat *etaPtr, NFloat *gammaPtr, NFloat *thetaPtr, NFloat *dstPtr) {
    int i, j, pos;
    NFloat floatVal;
...
/* cz277 - pact */
static void ApplyDParmSigmoidActCPU(NFloat *srcPtr, int row, int col, NFloat *etaPtr, NFloat *gammaPtr, NFloat *thetaPtr, NFloat *dstPtr) {
    int i, j, pos;
...
/* cz277 - pact */
static void ApplyTrParmSigmoidActCPU(NFloat *errPtr, NFloat *inpPtr, int row, int col, NFloat *etaPtr, NFloat *gammaPtr, NFloat *thetaPtr, Boolean accFlag, NFloat *dEtaPtr, NFloat *dGammaPtr, NFloat *dThetaPtr) {
    int i, j, pos;
...
/* cz277 - laf */
static void ApplyParmReLUActCPU(NFloat *inpPtr, int row, int col, NFloat *posPtr, NFloat *negPtr, NFloat *dstPtr) {
    int i, j, pos;
...
/* cz277 - laf */
static void ApplyDParmReLUActCPU(NFloat *inpPtr, int row, int col, NFloat *posPtr, NFloat *negPtr, NFloat *dstPtr) {
    int i, j, pos;
...
static void ApplyTrParmReLUActCPU(NFloat *errPtr, NFloat *inpPtr, int row, int col, Boolean accFlag, NFloat *dPosPtr, NFloat *dNegPtr) {
    int i, j, pos;
...
/* cz277 - pact */
static void ApplyPReLUActCPU(NFloat *srcPtr, int row, int col, NFloat *scalePtr, NFloat *dstPtr) {
    int i, j, pos;
...
/* cz277 - pact */
static void ApplyDPReLUActCPU(NFloat *srcPtr, int row, int col, NFloat *scalePtr, NFloat *dstPtr) {
    int i, j, pos;
...
/* cz277 - pact */
static void ApplyTrPReLUActCPU(NFloat *errPtr, NFloat *srcPtr, int row, int col, NFloat *scalePtr, Boolean accFlag, NFloat *dScalePtr) {
    int i, j, pos;
    NFloat act;
...
static void ApplyDSoftReLActCPU(NFloat *srcPtr, int len, NFloat *dstPtr) {
    int i;
    NFloat expVal;
...
#ifdef MKL
static void ApplyDSoftReLActMKL(NFloat *srcPtr, int len, NFloat *dstPtr) {
    int i;
...
static void ApplySoftReLActCPU(NFloat *srcPtr, int len, NFloat *dstPtr) {
    int i;
    NFloat expVal;
...
#ifdef MKL
static void ApplySoftReLActMKL(NFloat *srcPtr, int len, NFloat *dstPtr) {
    int i;
...
static void ApplySigmoidActCPU(NFloat *srcPtr, int len, NFloat *dstPtr) {
    int i;
    float floatVal;
...
#ifdef MKL
static void ApplySigmoidActMKL(NFloat *srcPtr, int len, NFloat *dstPtr) {
    int i;
...
static void ApplyDSigmoidActCPU(NFloat *srcPtr, int len, NFloat *dstPtr) {
    int i;
...
#ifdef MKL
static void ApplyDSigmoidActMKL(NFloat *srcPtr, int len, NFloat *dstPtr) {
    /*int len;
...
static void ApplyTanHActCPU(NFloat *srcPtr, int len, NFloat *dstPtr) {
    int i;
    float floatVal;
...
#ifdef MKL
static void ApplyTanHActMKL(NFloat *srcPtr, int len, NFloat *dstPtr) {
    int i;
...
static void ApplyDTanHActCPU(NFloat *srcPtr, int len, NFloat *dstPtr) {
    int i;
...
#ifdef MKL
static void ApplyDTanHActMKL(NFloat *srcPtr, int len, NFloat *dstPtr) {
    /*int len;
...
static void ApplySoftmaxActCPU(NFloat *srcPtr, int row, int col, NFloat *dstPtr) {
    int i, j, off;
...
#ifdef MKL
static void ApplySoftmaxActMKL(NFloat *srcPtr, int row, int col, NFloat *dstPtr) {
    int i, j, off;
    NFloat sumval, maxval;
...
static void ApplySoftSignActCPU(NFloat *srcPtr, int len, NFloat *dstPtr) {
    int i;
...
static void ApplyLogTransCPU(NFloat *srcPtr, int len, NFloat *dstPtr) {
    int i;
...
static void SumNMatrixByColCPU(NFloat *srcPtr, int row, int col, Boolean accFlag, NFloat *dstPtr) {
...
static void SquaredNSegmentCPU(NFloat *srcPtr, int segLen, NFloat *dstPtr) {
    int i;
...
#ifdef MKL
static void SquaredNSegmentMKL(NFloat *srcPtr, int segLen, NFloat *dstPtr) {
    #ifdef DOUBLEANN
...
static void CompAdaGradNSegmentCPU(NFloat eta, int K, int segLen, NFloat *ssgSeg, NFloat *nlrSeg) {
    int i;
...
static void FindMaxElementCPU(NFloat *srcPtr, int row, int col, IntVec resVec) {
    int maxIdx, i, j;
    NFloat maxVal;
...
static void HNBlasNNgemmCPU(int m, int n, int k, NFloat alpha, NFloat *A, NFloat *B, NFloat beta, NFloat *C) {
    int i, j, l;
...
#ifdef MKL
static void HNBlasNNgemmMKL(int m, int n, int k, NFloat alpha, NFloat *A, NFloat *B, NFloat beta, NFloat *C) {
    #ifdef DOUBLEANN
...
static void HNBlasNTgemmCPU(int m, int n, int k, NFloat alpha, NFloat *A, NFloat *B, NFloat beta, NFloat *C) {
    int i, j, l;
...
#ifdef MKL
static void HNBlasNTgemmMKL(int m, int n, int k, NFloat alpha, NFloat *A, NFloat *B, NFloat beta, NFloat *C) {
    #ifdef DOUBLEANN
...
static void HNBlasTNgemmCPU(int m, int n, int k, NFloat alpha, NFloat *A, NFloat *B, NFloat beta, NFloat *C) {
    int i, j, l;
...
#ifdef MKL
static void HNBlasTNgemmMKL(int m, int n, int k, NFloat alpha, NFloat *A, NFloat *B, NFloat beta, NFloat *C) {
    #ifdef DOUBLEANN
...
static void CalXENTCriterionCPU(NFloat *refSeg, NFloat *hypSeg, int segLen) {
    int i;
    NFloat tn, yn, sum;
...
static void CalMMSECriterionCPU(NFloat *refSeg, NFloat *hypSeg, int segLen) {
    int i;
...
static void AddNSegmentTargetPenCPU(NFloat *srcSeg, NFloat *penSeg, int row, int col, NFloat *dstSeg) {
    int i, j;
...
#ifdef MKL
static void AddNSegmentTargetPenMKL(NFloat *srcSeg, NFloat *penSeg, int row, int col, NFloat *dstSeg) {
    int i;
...
static void ShiftNSegmentValsCPU(NFloat *srcSeg, int segLen, NFloat shiftVal, NFloat *dstSeg) {
    int i;
